...
public interface ManagerRole {
    @MenuPolicy(menuIds = {"Task_.browse", "Subtask.browse", "User.browse", "ProjectStats.browse", "Project.browse"})
    @ScreenPolicy(screenIds = {"Project.browse", "Task_.browse", "Subtask.browse", "User.browse", "ProjectStats.browse", "Project.edit", "Task_.edit", "User.edit"})
    void screens();
